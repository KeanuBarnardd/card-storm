...
public class StoreService
{
  ...
  public List<Item> storeItems = new List<Item>{
    ...
    new Item{id= Guid.NewGuid() , title="Swann 4K Thermal Sensing Spotlight DVR Camera", description="See faces, license plates, packages & more with crystal clear 4K resolution, that’s 4x clearer than 1080p with powerful digital zoom – ensuring you won’t miss a thing.", price= 250, img_Url="" },
    ...
    new Item{id= Guid.NewGuid() , title="Orion Grid Connect 2MP Smart Outdoor Security Camera", description="This Orion SMART Outdoor Security Camera allows you to see and record activity in front of the home/garage from your smartphone or tablet anywhere and anytime.", price=79,img_Url=""},
    ...
    new Item{id= Guid.NewGuid() , title="Orion Grid Connect Smart HD 3MP Security Camera And Twin Floodlight", description="This Orion SMART Twin Floodlight Camera allows you to see and record activity in front of the home/garage from your smartphone or tablet anywhere and anytime.", price=149, img_Url=""}
  };
}
